...
Route::group([
    ...
    Route::post('/profile/update/bank_info', 'UserProfileController@updateUserBankInfo');
    ...
    Route::post('/course/check_validation', 'Courses\CoursesController@requestForValidationCheck');
